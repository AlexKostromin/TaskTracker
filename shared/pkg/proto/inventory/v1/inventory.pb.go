...
type PartsFilter struct {
	...
	Categories []Category `protobuf:"varint,3,rep,packed,name=categories,proto3,enums=inventory.v1.Category" json:"categories,omitempty"`
...
type Part struct {
	...
	Category Category `protobuf:"varint,6,opt,name=category,proto3,enums=inventory.v1.Category" json:"category,omitempty"`
...
func (x *Part) GetUpdatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1cinventory/v1/inventory.proto\x12\finventory.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"E\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseB%Z#hw1/shared/inventory/v1;inventoryV1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	2,  // 0: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	...
	6,  // 3: inventory.v1.GetPartResponse.part:type_name -> inventory.v1.Part
	...
	4,  // 11: inventory.v1.InventoryService.GetPart:input_type -> inventory.v1.GetPartRequest
	1,  // 12: inventory.v1.InventoryService.ListParts:input_type -> inventory.v1.ListPartsRequest
	5,  // 13: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
	3,  // 14: inventory.v1.InventoryService.ListParts:output_type -> inventory.v1.ListPartsResponse
